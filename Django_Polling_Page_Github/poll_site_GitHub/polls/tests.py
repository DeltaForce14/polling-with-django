...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        # was_publishe_recently() returns False for questions whose pub_date is older than 1 day.
...
class QuestionIndexViewTest(TestCase):
    def test_no_questions(self):
         # If no question exists, an appropriate message is displayed "No polls area available."
    ...
    def test_past_question(self):
         # Question with the past publish date are displayed on the index page.
